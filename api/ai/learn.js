// Vercel Serverless Function — AI Learn Endpoint
// Streams AI response for Learning Hub topic content
  ...
  try {
    ...
    const response = await fetch(`${baseUrl}/chat/completions`, {
      ...
      body: JSON.stringify({
        model,
        messages: [
          { role: 'system', content: systemPrompt || 'You are a digital marketing educator.' },
